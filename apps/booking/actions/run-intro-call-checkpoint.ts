  ...
  run: async ({ leadId }, ctx) => {
    ...
    await db
      ...
      .set({
        ...
        introResearchJson: JSON.stringify(research),
        introProduct: scorecard.product,
        introProductSignal: scorecard.productSignal,
        introEnterpriseNeedScore: scorecard.enterpriseNeed.score,
        introEnterpriseNeedLabel: scorecard.enterpriseNeed.label,
        introEnterpriseNeedSignals: JSON.stringify(scorecard.enterpriseNeed.signals),
        introIcpFitScore: scorecard.icpFit.score,
        introIcpFitLabel: scorecard.icpFit.label,
        introIcpFitSignals: JSON.stringify(scorecard.icpFit.signals),
        introMaturityStage: scorecard.maturityStage,
        introMaturityStageReason: scorecard.maturityStageReason,
        introPainScore: checkpoint.painScore,
        introPainLabel: checkpoint.painLabel,
        introPainRationale: checkpoint.painRationale,
        introChampionScore: checkpoint.championScore,
        introChampionLabel: checkpoint.championLabel,
        introChampionRationale: checkpoint.championRationale,

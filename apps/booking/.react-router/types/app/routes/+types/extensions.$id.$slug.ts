...
type Module = typeof import("../extensions.$id.$slug.js")

type Info = GetInfo<{
  file: "routes/extensions.$id.$slug.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../extensions.$id.js");
}, {
  id: "routes/extensions.$id.$slug";
  module: typeof import("../extensions.$id.$slug.js");
}];

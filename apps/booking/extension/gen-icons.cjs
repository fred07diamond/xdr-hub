// Generates placeholder PNG icons for the extension. Run with: node gen-icons.cjs
// Outputs icon-16.png, icon-32.png, icon-48.png, icon-128.png
// No dependencies — pure Node.js with built-in zlib. Ported from
// apps/li-agent/extension/gen-icons.cjs, just recolored -- swap these out
// for real brand art before shipping.
...
function createPNG(size) {
  // Indigo #6366f1 with rounded corners (radius = 22% of size), RGBA

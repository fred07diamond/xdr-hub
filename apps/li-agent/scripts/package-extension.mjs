// Packages the Chrome extension into a zip ready for either:
...
// debug.js, test-parse.js, and gen-icons.cjs are intentionally left out.
//
...
const outputZip = path.join(extensionDir, "builder-li-extension.zip");
...
const staging = mkdtempSync(path.join(tmpdir(), "bli-package-"));
try {

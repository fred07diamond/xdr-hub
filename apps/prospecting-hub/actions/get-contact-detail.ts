  ...
  run: async ({ contactId }, ctx) => {
    ...
    const contactRows = await db
      .select({
        ...
        apolloEmailStatus: contacts.apolloEmailStatus,
        apolloIndustry: contacts.apolloIndustry,
        apolloEmployeeCount: contacts.apolloEmployeeCount,
        apolloFundingStage: contacts.apolloFundingStage,
        apolloTotalFunding: contacts.apolloTotalFunding,
        apolloEnrichedAt: contacts.apolloEnrichedAt,

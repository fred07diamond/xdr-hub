...
export const contacts = table("contacts", {
  ...
  // AI-drafted outreach copy (Task 7) — generated by draft-outreach.ts via
  // generate-contact-draft.ts/bulk-generate-drafts.ts, grounded in the
  // contact's matched persona's linked Sales Library docs plus the Customer
  // Evidence Quick Reference doc's single per-persona proof point. All four
  // null until a draft has been generated at least once; regenerating
  // overwrites in place (no draft history/versioning).

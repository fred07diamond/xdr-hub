<!--
This file preserves the complete, verbatim "V2 Outbound Playbook" that Fred
Diamond pasted into the Prospecting Hub build session on 2026-08-01 —
Builder's real sales qualification methodology (Stage 1 Gate criteria,
MEDPICC, the four-persona framework with Design/Eng/Product/Exec profiles
and playbooks, Contact Sales handling, Agency routing, discovery-question
selection logic, email voice rules, scoring rubric, objection handling,
customer evidence). Fred's own framing: "This is the ultimate guide to
qualification. This qualification guideline should be the bread and butter
for this new scoring system along with everything else we have discussed."

The same content is also split into ~20 focused, individually AI-tagged
documents in the app's own Sales Library (in-app, DB-backed, browsable at
/library) so it can be linked to specific Personas/ICPs and feed the
scoring/derivation prompts directly. This file is the durable, checked-in
source of truth for that split — a future engineering session working on
the qualification/scoring system should start here.

Not part of this document: three unrelated "Prospecting Hub" app feature
requests (Create with AI button, LinkedIn Agent integration, Edit with AI)
that appeared at the very top of Fred's paste — those are a separate
product feature-backlog item, tracked outside the Sales Library.
-->

# Fusion gives product, design, and development teams full visual control

to generate, iterate, and ship enterprise-ready web apps---powered by

your design system and codebase.
...
-   Enterprise security, production workflows

 

-   Fine-tuned agent who understands design systems, component libraries

    > and UI/UX best practices

 

-   Best-in-class Figma integration

 

-   Covers end-to-end software development lifecycle

 

-   Accessible entire product development team: product, design, and

    > engineering.

 

-   Precision design control via a visual canvas to get concepts to

    > pixel-perfect in code

 

-   Brings business context and logic from other solutions to inform the

    > output of the agent

 

-   Access, share, and deploy work using existing tools, processes, and

    > workspaces: cloud-based application, Slack, shareable preview

    > links, Github, CI/CD pipelines, local development environments
...
-   [**[Fusion Sales
    ...
    > Deck]{.underline}**](https://docs.google.com/presentation/d/13mX0ZBCuM8vCa7eakNTJ4-OjWqnUeoqL5K6wB0tKvtI/edit?slide=id.g35f267d6e84_0_719#slide=id.g35f267d6e84_0_719)

 

-   [**[Fusion

    > One-Pager]{.underline}**](https://drive.google.com/file/d/1WYAgBcHXd50bOUGhh14sLm28PO0TOl74/view?usp=sharing)

 

-   [**[Fusion General

    > Messaging]{.underline}**](https://www.notion.so/Fusion-Cross-Persona-Messaging-updated-Jun-2025-21b3d7274be580948ceccbb2941b06a6?pvs=21)

 

-   [**[Fusion Persona

    > Messaging]{.underline}**](https://www.notion.so/Visual-Development-Platform-Messaging-updated-May-2025-1dc3d7274be580778f37eaa868c546c4?pvs=21)
...
-   [**[Fusion
    ...
    > Docs]{.underline}**](https://www.builder.io/c/docs/projects)

 

-   [**[Steve's Fusion Demo (8

    > mins)]{.underline}**](https://www.youtube.com/watch)

 

-   [**[Builder Labs: Implement features in your webapp with AI (1

    > hour)]{.underline}**](https://www.builder.io/hub/webinars/implement-webapp-features-with-ai/watch-now)
...
### **📊 [[Product]{.underline}](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)**

 

-   [**[Profile]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)

 

-   [**[Playbook]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)

 

### **🖼️** [**[Design]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)
...
-   [**[Goals]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)

 

-   [**[Pain

    > Points]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)

 

-   [**[Use

    > Cases]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)
...
-   [**[Qualifying
    ...
    > Questions]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)
...
-   [**[Objections &
    ...
    > Responses]{.underline}**](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)
...
**Description:** Senior product executives responsible for setting

product vision, portfolio strategy, and release cadence.

 

-   They want shorter idea-to-launch cycles, reliable user insights, and

    > fewer hand-offs that slow teams down

 

-   They care about ROI of tooling, adoption at scale, and how well a

    > solution integrates with existing design-systems and engineering

    > processes

 

-   Success looks like higher iteration velocity, measurable UX

    > improvements, and reduced engineering drag
...
Chief Product Officer (CPO), VP of Product, Head of Product, Director of

Product Strategy & Innovation, Director of Product Development, Group

Product Manager (Portfolio or Platform)
...
**Description:** Mid-level product leaders who own an entire surface

area of the product: often a platform, workflow, or major pillar.

 

-   They translate executive strategy into roadmaps, coordinate multiple

    > product teams (PM, Designer, and Engineering), and are accountable

    > for domain-level metrics (e.g., adoption, NPS, iteration

    > velocity).

 

-   Their biggest headache is the prototype-to-production gap:

    > recreating comps, chasing feedback, and waiting on dev/design

    > capacity.

 

-   A solution that lets their team ship high-fidelity prototypes, run

    > reliable tests, and push updates without a full sprint removes

    > that drag and helps them hit quarterly OKRs.

 

**Titles:** Sr. Manager of Product, Group Product Manager (Product or

Domain), Principal Product Manager, Sr. Product Manager, Product

Operations Manager, Program Manager

 

## **Individual Contributor, Product**

 

**Description:** Hands-on PMs responsible for a single feature,

workflow, or smaller product area.

 

-   They write specs, run discovery, and partner closely with design &

    > engineering to deliver incremental value

 

-   Daily pain points include rebuilding the same screens in Figma, slow

    > feedback loops, and waiting on engineering to fix "small" UI

    > issues

 

**Titles:** Sr. Product Manager, Product Manager, Product Owner
...
-   Accelerate iteration cycles for faster feature development

 

-   Generate production-ready prototypes for reliable user testing

 

-   Enable independent deployment of small UI changes
...
-   Quality and fidelity of user testing feedback

 

-   Number of iterations completed per sprint
...
-   Reduction in engineering dependency for minor changes
...
-   High-fidelity prototypes that mirror actual UI

 

-   Faster feedback cycles from user testing
...
-   Better product decisions based on reliable testing data
...
-   Prototype to production gap with quality outputs from current tools

 

-   Time-consuming recreation of prototypes in Figma

 

-   Error-prone handoffs between design and engineering

 

-   Small UI changes requiring full development cycles
...
-   Continued slow iteration cycles

 

-   Poor quality user testing due to low-fidelity prototypes

 

-   Wasted time on manual prototype recreation

 

-   Missed opportunities for rapid product improvements

 

-   Higher dependency on engineering resources
...
-   Rapid release cycles requiring faster iteration

 

-   Need for reliable user testing and feedback

 

-   Competitive pressure for product improvements
...
**Use Case 1: Rapid Prototype Development**

 

-   Create interactive, high-fidelity prototypes using existing design

    > system

 

-   Generate prototypes that accurately represent production UI

 

-   Enable reliable user testing with realistic interactions

 

-   Iterate quickly on user feedback without engineering involvement

 

**Use Case 2: Independent UI Updates**

 

-   Make small UI changes and updates without full development cycles

 

-   Deploy minor improvements and adjustments independently

 

-   Test variations and improvements rapidly

 

-   Reduce engineering bottlenecks for simple changes

 

**Use Case 3: Design System Integration**

 

-   Leverage existing component library for consistent prototyping

 

-   Ensure prototype fidelity matches production components

 

-   Maintain design system standards across prototypes

 

-   Enable seamless transition from prototype to production
...
## **Qualifying Questions for Product**
...
-   \"Tell me about your role in product development\"

 

-   "What are the current goals for your design team?"

 

-   \"How do you currently handle prototyping and user testing?\"
...
-   \"What tools do you currently use for prototyping?\"

 

-   \"How do you ensure your prototypes accurately represent the final

    > product?\"

 

-   \"What\'s your typical timeline from idea to prototype to

    > production?\"

 

-   \"How do you coordinate between design and engineering teams?\"
...
-   \"What\'s the biggest challenge in your current prototyping

    > workflow?\"

 

-   \"How often do prototypes fail to represent the actual user

    > experience?\"

 

-   \"What would happen if you could reduce prototype-to-production time

    > by 50%?\"

 

-   \"How much time do you spend recreating designs in different

    > tools?\"

 

## **MEDPICC Qualification for Product**
...
-   \"What\'s your budget for product development tools?\"

 

-   \"How do you measure ROI on tools that improve development

    > velocity?\"

 

-   \"What\'s the cost of slow iteration cycles to your business?\"
...
-   \"Who makes decisions about product development tooling?\"

 

-   \"How do tool purchases get approved in your organization?\"

 

-   \"Who would need to sign off on a platform like Builder?\"
...
-   \"What are your must-haves for prototyping and development tools?\"

 

-   \"How important is integration with your existing design system?\"

 

-   \"What would make a tool successful for your product team?\"
...
-   \"What\'s your procurement process for software tools?\"
...
-   \"What approval steps are needed for new tools?\"
...
-   \"How much time do you spend on manual prototype recreation?\"

 

-   \"What\'s the impact of poor prototype fidelity on user testing?\"

 

-   \"How do slow iteration cycles affect your product roadmap?\"
...
-   \"Who else would benefit from faster prototyping workflows?\"

 

-   \"Which team members are most frustrated with current processes?\"

 

-   \"Who would advocate for better design-development integration?\"
...
-   \"What other prototyping tools have you evaluated?\"

 

-   \"Are you considering any other development acceleration

    > platforms?\"

 

-   \"How do current tools like v0 or Figma work for your needs?\"

 

## **Common Objections & Responses from Product**

 

  ---------------------------------------------------------------------------

  **Theme**      **Objection**      **Response**            **Follow Up**

  -------------- ------------------ ----------------------- -----------------

  **Tool         \"We already have  Builder integrates with \"What specific

  Complexity**   multiple tools -   your existing workflow  integration

                 adding another     and design system,      points are most

                 might create more  reducing tool switching important for

                 complexity\"       rather than adding      your workflow?\"

                                    complexity\"            

 

  **Quality      \"AI-generated     \"Builder uses your     \"What quality

  Concerns**     prototypes might   actual design system    standards are

                 not have the       components, ensuring    most critical for

                 quality we need\"  prototypes match        your
...
***Q: \"How does Builder ensure prototypes match our production UI?\"***

 

**A:** \"Builder connects directly to your design system and component

library, using the same components your engineers use\"

 

***Q: \"Can we integrate with our existing Storybook setup?\"***

 

**A:** \"Yes, Builder can use Storybook as context to understand your

components and generate consistent code\"
...
***Q: \"What\'s the ROI for implementing Builder for prototyping?\"***

 

**A:** \"Teams typically see 60-80% reduction in prototype development

time and significantly better user testing outcomes\"

 

***Q: \"How does this help with our rapid release cycles?\"***

 

**A:** \"Builder enables faster iteration by allowing non-engineers to

create production-ready prototypes independently\"
...
***Q: \"How do we transition our current prototyping workflow to

Builder?\"***

 

**A:**\"We start with your design system integration, then gradually

expand usage across product teams\"
...
-   [[\*\*Qualifying]{.underline}](https://www.notion.so/Fusion-2393d7274be5808aab29d434d53f3a7e?pvs=21)
...
**Seniority Level:** High

 

**Leader Titles:** Chief Design Officer, VP of Design, Sr. Director of

UX, Head of UX, Director of Product Design, Principal Design, Staff

Designer

 

**Leader Description:** Senior design executives who own the end-to-end

user-experience strategy, design-system governance, and the creative

culture of the product organization. Their mandate is to deliver

consistently exceptional UX at enterprise scale while moving as fast as
...
**Manager Titles:** Principal Designer, Staff Designer, Design System

Lead

 

**Manager Description:** Design managers responsible for overseeing

product design strategy and team coordination. Focuses on AI-assisted

design workflows, design-to-development handoffs, and evaluating new

tools and processes to improve team efficiency.

 

### **Individual Contributor, Design**
...
**IC Titles:** Senior UX Designer, User Experience Designer
...
Leading design for external and internal applications. Responsible for

creating user experiences for a focus area of specific users.
...
-   Maintain design quality while increasing implementation velocity
...
-   Streamline design-to-development process

 

-   Enable faster iteration and testing of design concepts
...
-   Successfully integrate AI tools into design processes

 

-   Accelerate design velocity through better tooling

 

-   Conduct user testing with functional prototypes before engineering
...
-   Smooth handoff process with minimal clarification needed

 

-   Accurate implementation of design intentions

 

-   Faster validation of design concepts through prototyping
...
-   High adoption among design team
...
-   **Reducing design-to-development friction\
    ...
    -   \"I think the gist of this, from my standpoint, is can we reduce

        > the gap between design and development? We\'re collaborative

        > by nature, sure, but design wants to help get closer to the

        > end product rather than design some static pixels or a

        > prototype and wait for dev to put it together and then ask us

        > a bunch of questions.\" - Adam Barton, Lumin Digital (05:24)

 

    -   \"It sounds like even small UI changes require these full

        > development cycles.\" - Erica Schaubroeck, ClickUp (05:57)
...
-   **AI-powered workflow acceleration\
    ...
    -   \"We are particularly interested in AI code generation. How does

        > it accelerate the lifecycle for us to deliver the UI? We have

        > been trying out Gemini, for example, putting a screenshot, and

        > it generates the mockups, so that has been exciting for us to

        > see how quickly we can generate the UI screens.\" - Dhaval

        > Thaker, Verizon (12:16)

 

    -   \[quote\] - Speaker, Customer
...
1.  Design handoff efficiency

 

2.  Team adoption rates
...
-   \[Question to understand their current process/tools\]

 

-   \[Question to identify inefficiencies\]
...
-   \[Question to uncover specific pain points\]

 

-   \[Follow-up question to quantify impact\]
...
-   \[Question about existing tech stack and integration needs\]

 

-   \[Question about security or compliance requirements\]
...
-   \[Question about available budget\]

 

-   \[Question about ROI justification\]
...
-   \[Question to identify decision maker\]

 

-   \[Question about buyer involvement in evaluation\]
...
-   \[Question about key evaluation criteria\]

 

-   \[Question about must-have capabilities\]
...
-   \[Question about procurement and legal process\]

 

-   \[Question about timeline for approvals\]
...
-   \[Question to quantify business impact\]

 

-   \[Question about consequences of inaction\]
...
-   \[Question to find internal advocate\]

 

-   \[Question about who benefits most from solving this pain\]
...
-   \[Question about other tools being evaluated\]

 

-   \[Question about comparison factors\]
...
**Objection:** \[Common objection statement\]

 

**Response:** \[Standard response to address objection\]

 

**Follow-up:** \[Follow-up question to deepen discussion\]
...
**A:** \[How to respond + when to involve solutions engineering\]

 

**When to escalate:** \[Criteria for looping in technical expert\]
...
**Q:** \[Common business question\]

 

**A:** \[How to address business concerns\]
...
**Q:** \[Common process question\]

 

**A:** \[How to guide them through next steps\]
...
Leads technology strategy and execution across the organization.

 

**Titles:** CTO, VP of Engineering, Director of Engineering, VP/Director

of Technology, Head of Engineering, Head of Technology

 

**Responsibilities:** Technology strategy, team management, platform

scalability, operational efficiency

 

**Pain Points:** Technology strategy, team management, platform
